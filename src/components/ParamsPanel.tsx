  ...
  return (
    <section className="space-y-6">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-5">
        <h3 className="font-medium text-sm mb-2">Tiers (mult × number of layers)</h3>
            ...
            <div key={r.category} className="flex flex-wrap items-center gap-2">
              ...
              <label className="flex items-center gap-1">
                ...
                <CommitNumberInput
                  ...
                  onCommit={(newValue) => handleCategoryRuleUpdate(r.category, 'override_number_of_layers', newValue || undefined)}
                  step={1}
                  min={0}
